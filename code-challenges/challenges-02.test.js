...
const raisedToTheThird = (arr) => {
  ...
  let localAr=[];
  arr.forEach((element) => {
    localAr.push(Math.pow(element,3));
  });
  return localAr
};
...
//console.log(appendTheEnd('This is my story.'));
...
//console.log(appendFirstToLast(['Yes', 'it', 'is']));
...
//console.log(addBirthYearProperty({ fullName: 'Octavia Butler' }, 1947));
/* ------------------------------------------------------------------------------------------------
